...
public class Jeroo extends JerooBase {
 ...
 /**
     * Jeroo should hop forward only if there is at least one flower on its left or on its right
     */
    ...
    /**
     * Jeroo should hop forward only if there is aa flower on its left and on its right
     */
